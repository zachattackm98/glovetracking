/*
  ...
  to ensure proper access control and type handling.
  
  1. Changes
     - Drops all existing policies to avoid conflicts
     - Creates new policies with proper type casting
     - Ensures consistent org_id and role checks
  
  2. Security
     - Maintains strict organization-based access control
     - Enforces admin-only deletion
     - Allows users to view and update their assigned assets
*/
